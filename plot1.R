...
total_emission<-aggregate(NEI$Emissions, list(NEI$year), sum)
plot(total_emission, xlab = 'Year', ylab = "Total emission of PM2.5(in tons)", main = "PM2.5 total emission", pch = 19)
